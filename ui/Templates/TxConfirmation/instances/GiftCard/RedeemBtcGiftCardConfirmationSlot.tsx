...
export interface RedeemBtcGiftCardConfirmationSlotProps {
  amount?: string;
...
export default function RedeemBtcGiftCardConfirmationSlot({
  amount = "$100",
...
}: RedeemBtcGiftCardConfirmationSlotProps) {
  return (
    <TxConfirmation
